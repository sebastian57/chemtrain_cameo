...
import numpy as onp
from jax import tree_util, numpy as jnp, vmap, Array
...
def quantity_multimap(*states: State,
    ...
    # Use vmap here to preserve the surrounding sharding context. Under newer
    # JAX versions, lax.map inside shard_map can introduce auto-sharding.
    bachted_quantity_trajs = vmap(single_state_quantities)(batched_samples)
